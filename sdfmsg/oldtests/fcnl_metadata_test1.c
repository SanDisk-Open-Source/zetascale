 ...
 *
 * $Id: fcnl_metadata_test1.c 308 2008-06-23 22:34:58Z normanxu $
 */
...
/*     fthInit(); // Init */
    ...
    pthread_create(&fthPthread, &attr, &MetadataPthreadRoutine, &myid);

    plat_log_msg(PLAT_LOG_ID_INITIAL, LOG_CAT, PLAT_LOG_LEVEL_TRACE,
            "\nNode %d: Created pthread for Metadata protocol test\n", myid);
    info->pthread_info = 1;
    info->fth_info = 3;
