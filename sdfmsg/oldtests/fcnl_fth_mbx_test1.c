 ...
 *
 * $Id: fcnl_fth_mbx_test1.c 308 2008-06-23 22:34:58Z normanxu $
 * 
 * Mainly test the wrapper APIs defined in sdf_fth_mbx.h
 */
...
int main(int argc, char *argv[]) {
    ...
    pthread_create(&fthPthread, &attr, &FthMbxPthreadRoutine, NULL);
