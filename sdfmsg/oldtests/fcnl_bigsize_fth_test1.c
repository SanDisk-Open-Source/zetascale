 ...
 *
 * $Id: fcnl_bigsize_fth_test1.c 308 2008-06-23 22:34:58Z normanxu $
 */
...
int main(int argc, char *argv[]) {
    ...
    pthread_create(&fthPthread, &attr, &BigSizeFthPthreadRoutine, NULL);
