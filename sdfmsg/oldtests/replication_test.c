 ...
 *
 * $Id: replication_test.c 308 2008-05-09 22:34:58Z tomr $
 */
...
void * ReplicationPthreadRoutine(void *arg) {
    int myid = *(int *)arg;
    struct sdf_queue_pair *q_pair_REPLICATION;
    ...
    plat_log_msg(PLAT_LOG_ID_INITIAL, LOG_CAT, PLAT_LOG_LEVEL_TRACE,
            "\nNode %d Exiting pthread REPLICATION Tester\n", myid);
    return (0);
}
