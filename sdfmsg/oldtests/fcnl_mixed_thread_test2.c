...
/*
 * File:   fcnl_mixed_thread_test2.c
 * Author: Norman Xu
 *
 ...
 *
 * $Id: fcnl_mixed_thread_test1.c 308 2008-07-22 22:34:58Z normanxu $
 */

/*!
 * @brief we create this test case to test sending and receiving with
 * both pthread and fth sender and receiver. In this test case, we try
 * the same protocol
 */
#ifdef MPI_BUILD
#include <mpi.h>
