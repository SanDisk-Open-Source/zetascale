/*
 * File:   fcnl_single_protocol_lib1.c
 * Author: mac
 *
 ...
 *
 * create one sender  and SDF_PROTOCOL_COUNT receivers, let the sender
 * sends the number of SDF_PROTOCOL_COUNT message to receivers, each receiver
...
void *
SingleProtocolPthreadRoutine(void *arg) {
