/*
 * File:   fcnl_multi_proto_test1.c
 * Author: mac
 *
 * Created on Jul 21, 2008, 12:02AM
 *
...
main(int argc, char *argv[]) {
    ...
    /* make sure this is first in order to get the log messages in the mpi init call */
    ...
    pthread_create(&fthPthread, &attr, &MultiProtocolPthreadRoutine, NULL);
