...
/*
 * File:   fcnl_wrapper_test1.c
 * Author: Zhenwei Lu
 *
 * Created on Oct 24, 2008, 7:45AM
 *
 * (c) Copyright 2008, Schooner Information Technology, Inc.
 * http://www.schoonerinfotech.com/
 *
 * $Id: fcnl_wrapper_test1.c 308 2008-06-23 22:34:58Z andrewLu $
 */
...
int main(int argc, char *argv[]) {
    ...
    pthread_create(&fthPthread, &attr, &WrapperPthreadRoutine, &myid);
