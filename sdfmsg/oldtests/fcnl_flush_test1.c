 ...
 *
 * $Id: fcnl_flush_test1.c 308 2008-06-23 22:34:58Z normanxu $
 */
...
int main(int argc, char *argv[]) {
    ...
    pthread_create(&fthPthread, &attr, &FlushPthreadRoutine, &myid);
    info->pthread_info = 1;
    info->fth_info = 2;
    plat_log_msg(PLAT_LOG_ID_INITIAL, LOG_CAT, PLAT_LOG_LEVEL_TRACE,
            "\nNode %d: Created pthread for consistency protocol, flush type test\n", myid);
