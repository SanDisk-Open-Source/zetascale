...
int
rt_dump_stats(rt_statistics_t *statistics, int dumpflag)
{
   int      i;
   int      events;
   int      max_non_zero;
   ...
   if (dumpflag) {
       ...
       printf("   Min:  %8.4g ms\n", ((double) statistics->min_time)/1000000);
       printf("   Max:  %8.4g ms\n", ((double) statistics->max_time)/1000000);
       printf("   Ave:  %8.4g ms\n", (average/1000000));
	  ...
	  geometric_mean = 0;
       ...
       printf("   Geo:  %8.4g ms\n", geometric_mean/1000000);

       if (events > 1)
       {
	  printf("   Std:  %8.4g ms\n",
	  sqrt((statistics->squares - events * average * average) / (events - 1))/1000000);
       }
