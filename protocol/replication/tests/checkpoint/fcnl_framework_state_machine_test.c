/*
 * File: $URL: svn://svn.schoonerinfotech.net/schooner-trunk/trunk/sdf/protocol/replication/tests/checkpoint/fcnl_framework_state_machine_test.c $
 ...
 *
 * $Id: fcnl_framework_state_machine_test.c 10690 2009-12-19 04:04:11Z drew $
 */
...
typedef struct cluster_node {
    int adm_state;       /* Enabled or disabled */
    int node_type;       /* Active or stand by */
    int grp_type;
