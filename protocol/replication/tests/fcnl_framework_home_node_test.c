...
/*
 * File:   fcnl_framework_home_node_test.c
 * Author: Songhe
 *
...
/**
 * 1. write 2 objects into home node, delete 1 object, crash home node
 */
...
int main(int argc, char **argv) {
    ...
    XResume(fthSpawn(&rt_mix_write_delete_entry, 40960), (uint64_t)test_framework);
