 ...
 *
 * $Id: copy_replicator_internal.h 8796 2009-08-19 00:21:54Z drew $
 */
...
enum {
    /* VIPG */
    CR_VIP_GROUP_MAGIC = 0x47504956,
    CR_VIP_GROUP_VERSION = 1
};

#define CR_VIP_GROUP_SHARD_STATE_ITEMS() \
    /** @brief Vip group should live here */                                   \
    item(CR_VGSS_PREFERRED, preferred)                                         \
    item(CR_VGSS_STALE, stale)                                                 \
    item(CR_VGSS_RECOVERED, recovered)
