...
int main() 
{
    ...
    if((fp = fopen("FDF_GetContainerStats.log", "w+")) == 0)
    {
   ...
   {
      fprintf(stderr, "#Test of FDFGetContainerStats pass!\n");
   }else{
      fprintf(stderr, "#Test of FDFGetContainerStats fail!\n");
   }
