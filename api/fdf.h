...
typedef enum {
    ...
    /* Application request at Btree layer. 
       Add new fdf specific stats above this line */
    FDF_ACCESS_TYPES_READ,
    FDF_ACCESS_TYPES_WRITE,
    FDF_ACCESS_TYPES_DELETE,
    FDF_ACCESS_TYPES_FLUSH,
    FDF_ACCESS_TYPES_MPUT,
    FDF_ACCESS_TYPES_MSET,
    FDF_ACCESS_TYPES_RANGE,
    FDF_ACCESS_TYPES_RANGE_NEXT,
    FDF_ACCESS_TYPES_RANGE_FINISH,
    FDF_ACCESS_TYPES_RANGE_UPDATE,
    FDF_ACCESS_TYPES_CREATE_SNAPSHOT,
    FDF_ACCESS_TYPES_DELETE_SNAPSHOT,
    FDF_ACCESS_TYPES_LIST_SNAPSHOT,
    FDF_ACCESS_TYPES_TRX_START,
    FDF_ACCESS_TYPES_TRX_COMMIT,
    FDF_N_ACCESS_TYPES
} FDF_access_types_t;

typedef enum { 
    /* Btree L1 stats */
    FDF_BTREE_L1_ENTRIES,
    FDF_BTREE_L1_OBJECTS,
    FDF_BTREE_LEAF_L1_HITS,
    FDF_BTREE_NONLEAF_L1_HITS,
    FDF_BTREE_OVERFLOW_L1_HITS,

    FDF_BTREE_LEAF_L1_MISSES,
    FDF_BTREE_NONLEAF_L1_MISSES,
    FDF_BTREE_OVERFLOW_L1_MISSES,
    FDF_BTREE_BACKUP_L1_MISSES,
    FDF_BTREE_BACKUP_L1_HITS,

    FDF_BTREE_LEAF_L1_WRITES,
    FDF_BTREE_NONLEAF_L1_WRITES,
    FDF_BTREE_OVERFLOW_L1_WRITES,
    /* Btree stats */
    FDF_BTREE_LEAF_NODES,
    FDF_BTREE_NONLEAF_NODES,

    FDF_BTREE_OVERFLOW_NODES,
    FDF_BTREE_LEAF_BYTES,
    FDF_BTREE_NONLEAF_BYTES,
    FDF_BTREE_OVERFLOW_BYTES,
    FDF_BTREE_NUM_OBJS,

    FDF_BTREE_TOTAL_BYTES,
    FDF_BTREE_EVICT_BYTES,
    FDF_BTREE_SPLITS,
    FDF_BTREE_LMERGES,
    FDF_BTREE_RMERGES,
    ...
    FDF_BTREE_LSHIFTS,
    FDF_BTREE_RSHIFTS,
    FDF_BTREE_EX_TREE_LOCKS,
    FDF_BTREE_NON_EX_TREE_LOCKS,
    FDF_BTREE_GET,
    FDF_BTREE_GET_PATH_LEN,
    FDF_BTREE_CREATE,
    FDF_BTREE_CREATE_PATH_LEN,
    FDF_BTREE_SET,
    FDF_BTREE_SET_PATH_LEN,
    FDF_BTREE_UPDATE,
    FDF_BTREE_UPDATE_PATH_LEN,
    FDF_BTREE_DELETE_PATH_LEN,
    FDF_BTREE_FLUSH_CNT,

    FDF_BTREE_DELETE_OPT_COUNT,
    FDF_BTREE_MPUT_IO_SAVED,
    FDF_BTREE_PUT_RESTART_CNT,
    FDF_BTREE_SPCOPT_BYTES_SAVED,
    FDF_BTREE_NUM_MPUT_OBJS,

    FDF_BTREE_NUM_RANGE_NEXT_OBJS,
    FDF_BTREE_NUM_RANGE_UPDATE_OBJS,
    FDF_BTREE_NUM_SNAP_OBJS,
    FDF_BTREE_SNAP_DATA_SIZE,
    FDF_BTREE_NUM_SNAPS,

    FDF_BTREE_NUM_BULK_INSERT_CNT,
    FDF_BTREE_NUM_BULK_INSERT_FULL_NODES_CNT,
    FDF_N_BTREE_STATS
}FDF_Btree_stat_t;
...
typedef enum {
    ...
    FDF_FLASH_STATS_THD_CONTEXTS,
    FDF_FLASH_STATS_ESCVN_OBJ_DEL,
    FDF_FLASH_STATS_ESCVN_YLD_SCAN_CMPLTE,
    FDF_FLASH_STATS_ESCVN_YLD_SCAN_RATE,

    FDF_FLASH_STATS_NUM_DATA_WRITES,
    FDF_FLASH_STATS_NUM_DATA_FSYNCS,
    FDF_FLASH_STATS_NUM_LOG_WRITES,
    FDF_FLASH_STATS_NUM_LOG_FSYNCS,
...
typedef struct {
	...
	uint64_t		 cntr_stats[FDF_N_CNTR_STATS];
        uint64_t                 btree_stats[FDF_N_BTREE_STATS];
