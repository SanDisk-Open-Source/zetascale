...
typedef enum {
    ...
    FDF_CACHE_STAT_LEAF_L1_HITS,
    FDF_CACHE_STAT_NONLEAF_L1_HITS,
    FDF_CACHE_STAT_OVERFLOW_L1_HITS,
    ...
    /* Btree stats */
    FDF_CACHE_STAT_BT_LEAF_NODES,
    FDF_CACHE_STAT_BT_NONLEAF_NODES,
    FDF_CACHE_STAT_BT_OVERFLOW_NODES,
    FDF_CACHE_STAT_BT_LEAF_BYTES,
    FDF_CACHE_STAT_BT_NONLEAF_BYTES,
    ...
    FDF_CACHE_STAT_BT_BULK_INSERT_CNT,
    FDF_CACHE_STAT_BT_BULK_INSERT_FULL_NODES_CNT,
